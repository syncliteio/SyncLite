...
func initializeDB(dbName, dbType string, loggerOptions map[string]interface{}) (SyncLiteDBResult, error) {
...
func closeDB(dbName string) (SyncLiteDBResult, error) {
jsonRequest := map[string]interface{}{
"db-name": dbName,
"sql":     "close",
}
...
func beginTransaction(dbName string) (SyncLiteDBResult, error) {
jsonRequest := map[string]interface{}{
"db-name": dbName,
"sql":     "begin",
}
...
func commitTransaction(dbName, txnHandle string) (SyncLiteDBResult, error) {
jsonRequest := map[string]interface{}{
"db-name":    dbName,
...
func rollbackTransaction(dbName, txnHandle string) (SyncLiteDBResult, error) {
jsonRequest := map[string]interface{}{
"db-name":    dbName,
"txn-handle": txnHandle,
"sql":        "rollback",
...
func executeSQL(dbName, txnHandle, sql string, arguments [][]interface{}, dataFormat string, includeMetadata *bool) (SyncLiteDBResult, error) {
jsonRequest := map[string]interface{}{
"db-name": dbName,
"sql":     sql,
}
...
fmt.Println("========================================================")
result, err := initializeDB(dbName, "SQLITE", nil)
if err != nil {
...
fmt.Println("========================================================")
r, err = executeSQL(dbName, txnHandle, "create table if not exists t1(a int, b text)", nil, "", nil)
if err != nil {
...
r, err = executeSQL(dbName, txnHandle, "insert into t1 (a,b) values(?, ?)", arguments, "", nil)
if err != nil {
...
fmt.Println("========================================================")
r, err = commitTransaction(dbName, txnHandle)
if err != nil {
...
fmt.Println("========================================================")
r, err = executeSQL(dbName, "", "select a, b from t1", nil, "", nil)
if err != nil {
...
dbFmtResult, err := executeSQL(dbName, "", "select a, b from t1", nil, "DB", &includeMetadata)
if err != nil {
...
fmt.Println("========================================================")
r, err = executeSQL(dbName, "", "drop table t1", nil, "", nil)
if err != nil {
