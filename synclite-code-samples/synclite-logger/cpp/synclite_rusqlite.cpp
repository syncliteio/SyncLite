...
int main() {
    try {
        // PostgreSQL destination example. Comment out and uncomment one
        // of the alternatives below for SQLite / DuckDB destinations.
        ...
        // shipper + consolidator have drained it.
        conn.flush();
        try {
