...
//!
//! Same canonical shape as `synclite_rusqlite_postgres.rs`. Defaults to
//! a PostgreSQL destination; see the commented alternatives below to
...
fn main() -> Result<()> {
    ...
    // synclite::initialize(
    //     DeviceType::SQLITE, DEVICE_NAME, DB_PATH,
    //     Some(DestinationOptions {
    ...
    // synclite::initialize(
    //     DeviceType::SQLITE, DEVICE_NAME, DB_PATH, None,
    //     SyncLiteOptions::default(),
    // )?;
