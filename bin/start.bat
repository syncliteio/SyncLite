...
call :refresh_war "SyncLite Sample App" "synclite-sample-app" "..\tools\synclite-sample-app\*.war" "..\target\synclite-platform-1.1.0\tools\synclite-sample-app\*.war" "..\synclite-sample-web-app\web\target\*.war"
if errorlevel 1 exit /b 1
call :refresh_war "SyncLite DB" "synclite-db" "..\tools\synclite-db\*.war" "..\target\synclite-platform-1.1.0\tools\synclite-db\*.war" "..\synclite-db\root\web\target\synclite-db-*.war" "..\synclite-db\root\web\target\*.war"
if errorlevel 1 exit /b 1
call :refresh_war "SyncLite DBReader" "synclite-dbreader" "..\tools\synclite-dbreader\*.war" "..\target\synclite-platform-1.1.0\tools\synclite-dbreader\*.war" "..\synclite-dbreader\root\web\target\synclite-dbreader-*.war" "..\synclite-dbreader\root\web\target\*.war"
if errorlevel 1 exit /b 1
call :refresh_war "SyncLite QReader" "synclite-qreader" "..\tools\synclite-qreader\*.war" "..\target\synclite-platform-1.1.0\tools\synclite-qreader\*.war" "..\synclite-qreader\root\web\target\synclite-qreader-*.war" "..\synclite-qreader\root\web\target\*.war"
if errorlevel 1 exit /b 1
call :refresh_war "SyncLite Job Monitor" "synclite-jobmonitor" "..\tools\synclite-jobmonitor\*.war" "..\target\synclite-platform-1.1.0\tools\synclite-jobmonitor\*.war" "..\synclite-job-monitor\root\web\target\synclite-jobmonitor-*.war" "..\synclite-job-monitor\root\web\target\*.war"
if errorlevel 1 exit /b 1
